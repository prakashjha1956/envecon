...
@section('content')
    ...
    {!! Form::model($request_to_technical, ['method' => 'PUT', 'route' => ['admin.request_to_technicals.update', $request_to_technical->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($request_to_technical->getMedia('upload_customer_sign_off_files') as $media)
                                <p class="form-group">
                                    <a href="{{ $media->getUrl() }}" target="_blank">{{ $media->name }} ({{ $media->size }} KB)</a>
                                    <a href="#" class="btn btn-xs btn-danger remove-file">Remove</a>
                                    <input type="hidden" name="upload_customer_sign_off_files_id[]" value="{{ $media->id }}">
                                </p>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('assigned_person[]', $assigned_people, old('assigned_person') ? old('assigned_person') : $request_to_technical->assigned_person->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
