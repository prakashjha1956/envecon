...
class TimeEntriesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.time_entries.create', $relations);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.time_entries.edit', compact('time_entry') + $relations);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.time_entries.show', compact('time_entry') + $relations);
    }
